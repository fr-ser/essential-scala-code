...
object Main extends App {
  ...
  println(ints.toString + """.exists(_ > 0)      == """ + ints.exists(_ > 0))
  println(ints.toString + """.exists(_ < 0)      == """ + ints.exists(_ < 0))
  println(ints.toString + """.exists(_ % 2 == 0) == """ + ints.exists(_ % 2 == 0))
  println(ints.toString + """.exists(_ % 2 == 1) == """ + ints.exists(_ % 2 == 1))
}
